...

{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-79e2f7ea-4c30-43cb-8166-bcb1dcec5e69" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."79e2f7ea-4c30-43cb-8166-bcb1dcec5e69" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "79e2f7ea-4c30-43cb-8166-bcb1dcec5e69";
      ...
      "kwinrc"."Desktops"."Id_1" = "56d2ed04-78df-4ab1-9973-bdb1e5d23c87";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."NightTemperature" = 5700;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/c2abe5da-cefc-57eb-84e9-e47a804cadfc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/ef5b17f2-2bb4-5d62-891b-e5209babb2b4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1.25;
      "kwinrc"."org.kde.kdecoration2"."theme" = "__aurorae__svg__Edna";
      "kxkbrc"."Layout"."DisplayNames" = ",,";
      "kxkbrc"."Layout"."LayoutList" = "gb,ua,se";
      "kxkbrc"."Layout"."Options" = "grp:alt_space_toggle";
...
❯ nix run github:nix-community/plasma-manager
{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."org.kde.kdecoration2"."theme" = "__aurorae__svg__Edna";
      "kxkbrc"."Layout"."DisplayNames" = ",,";
      "kxkbrc"."Layout"."LayoutList" = "us,ua,se";
      "kxkbrc"."Layout"."Options" = "grp:alt_space_toggle";
      "kxkbrc"."Layout"."ResetOldOptions" = true;
      "kxkbrc"."Layout"."SwitchMode" = "WinClass";
      "kxkbrc"."Layout"."Use" = true;
